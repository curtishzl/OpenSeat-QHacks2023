...
<html>
    ...
    // Print % capacity
        ...
        echo "Stauffer Library is currently " . $percent_full . "% full.<br><br>";
    ?>

    <?php
    // Print all seats
        $sql = "SELECT * FROM nfc_tags WHERE library='stauffer';"; // select all (*)     ...nfc_tags WHERE occupied=1;
        $result = mysqli_query($conn, $sql);
